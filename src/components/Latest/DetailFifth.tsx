  ...
  return (
    <div className="sm:mx-20 md:mx-30 lg:mx-40 xl:mx-56">
      ...
      <div>
        ...
        <div className="mt-10">
          <img
            src="https://demo2.posthemes.com/pos_junno/modules/xipblog/img/large-blog1.jpg"
            alt="jordan"
        ...
        {/* Content */}
        <div className="mt-5">
          <h3 className="my-3 capitalize text-lg antialiased font-bold underline">
            This is fifth post for XipBlog
          </h3>
          <div className="flex font-extralight text-sm">
            ...
            <p className="border-r-2 border-current px-2">May 29MO, 2023</p>
            <p className="px-2 text-red-500">Fashion</p>
          </div>
          <div className="my-3 font-thin text-justify text-ml">
            ...
            consectetur adipisicing elit, do eiusmod tempor incididunt ut labore
            et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur
            adipisicing elit, do eiusmod tempor incididunt ut labore et dolore
            magna aliqua. Ut enim adminim veniam, quis nostrud exercitation
            ullamco laboris nisi ut aliquip commodo consequat. Duis aute irure
            ...
            adipisicing elit, do eiusmod tempor cididunt ut labore et dolore
            magna aliqua. Lorem ipsum dolor sit amet, consectetur adipisicing
            elit, do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            ...
            aliqua. Lorem ipsum dolor sit amet, consectetur adipisicing elit, do
